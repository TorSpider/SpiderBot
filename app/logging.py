...
class Logger:
    def __init__(self):
        ...
        try:
            ...
            if not log_to_console:
                log_to_console = config['LOGGING'].getboolean('LogToConsole')
    ...
    def __get_logger(loglevel, script_dir, log_to_console):
        ...
        my_logger = logging.getLogger('SpiderBot')
        os.makedirs(os.path.join(script_dir, 'logs'), exist_ok=True)
        filehandler = TimedRotatingFileHandler(
            os.path.join(script_dir, 'logs', 'SpiderBot.log'),
